...
IncomeTaxQuickLookupItem = namedtuple('IncomeTaxQuickLookupIttm', ['start_point', 'tax_rate', 'quick_subtractor'])
...
class IncomeTaxCalculator(Process):
    ...
    @classmethod
    def calc_income_tax_add_remain(cls, income):
    ...
    def calc_for_all_userdata(self):
        while True:
            ...
            tax, remain = self.calc_income_tax_add_remain(income)
